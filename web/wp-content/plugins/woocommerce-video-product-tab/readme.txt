...
Extends WooCommerce to allow you to add a Video to the Product page. Creates a new tab to display your embeded video.
...
To contribute to the plugin, visit https://github.com/seb86/WooCommerce-Video-Product-Tab/blob/master/CONTRIBUTING.md for details.
...
= Will WooCommerce Video Product Tab work with my theme? =

Yes; My plugin uses the same styling for any theme that is WooCommerce compaitable.

= Where can I report bugs or contribute to the plugin? =
