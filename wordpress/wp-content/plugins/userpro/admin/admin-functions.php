	...
	?>
			<div class="userpro-admin-head">
				<div class="userpro-admin-left">
					...
					<span class="userpro-admin-span"><?php if (get_option('userpro_activated')) { _e('This copy has been activated. Thank you =)','userpro'); } else { _e('This copy has been activated by : CapacityCode','userpro'); } ?></span>
				</div>
				<div class="userpro-admin-right">
					...
					<a href="https://www.facebook.com/IvanKarl17" class="button"><?php _e('Follow me on Facebook','userpro'); ?></a>
