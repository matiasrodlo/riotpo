		...
		function All_in_One_SEO_Pack_Feature_Manager( $mod ) {
			...
			$this->module_info = Array( 'sitemap'	=> Array( 'name'		=> __( 'XML Sitemaps', 'all_in_one_seo_pack' ),
										...
										'importer_exporter'	=> Array( 'name' => __( 'Importer & Exporter', 'all_in_one_seo_pack' ),
															  'description' => __( 'Exports your SEO settings and imports settings from other WordPress SEO plugins.', 'all_in_one_seo_pack' ) ),
										...
										'coming_soon' => Array( 'name'			=> __( 'Coming Soon...', 'all_in_one_seo_pack' ),
																...
																'save'		=> false ),
										'coming_soon2' => Array( 'name'			=> __( 'Coming Soon...', 'all_in_one_seo_pack' ),
					 											'description'	=> __( 'News Sitemap', 'all_in_one_seo_pack' ),
																'save'		=> false )
									);
