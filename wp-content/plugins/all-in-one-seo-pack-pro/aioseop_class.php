...
class All_in_One_SEO_Pack extends All_in_One_SEO_Pack_Module {
	...
	function add_admin_pointers() {
		$this->pointers['aioseop_menu_220'] = Array( 'pointer_target' => '#toplevel_page_all-in-one-seo-pack-pro-aioseop_class',
		...
		$this->pointers['aioseop_welcome_220'] = Array( 'pointer_target' => '#aioseop_top_button',
													...
													. '</h3><p>' . __( 'New in 2.2: a robots.txt generator and file editor; enable them from our feature manager! And please review your settings, we have added some new ones!', 'all_in_one_seo_pack' ) . '</p>',
													 'pointer_edge' => 'bottom',
													 'pointer_align' => 'left',
													 'pointer_scope' => 'local'
											 );
		...
		switch ( $meta['id'] ) {
			case "aioseop-about":
				?><div class="aioseop_metabox_text">
							...
							<p><a target="_blank" title="<?php _e( 'All in One SEO Pro Plugin Support Forum', 'all_in_one_seo_pack' ); ?>"
							href="http://semperplugins.com/support/"><?php _e( 'Support Forum', 'all_in_one_seo_pack' ); ?></a></p>
							<p><a target="_blank" title="<?php _e( 'All in One SEO Pro Plugin Changelog', 'all_in_one_seo_pack' ); ?>"
							href="http://semperplugins.com/documentation/all-in-one-seo-pack-pro-changelog/"><?php _e( 'Changelog', 'all_in_one_seo_pack' ); ?></a></p>
						</div>
				<?php
		    case "aioseop-donate":
		        ?>
