...
function calculation_used_type_change(){
	if(jQuery("#woocommerce_rewards_settings_swr_rewards_used_type").val() == 'pointsvalue'){
		...
		jQuery("#woocommerce_rewards_settings_swr_rewards_min_points").parents("tr").show();
		if(jQuery("#woocommerce_rewards_settings_swr_rewards_calculation").val() == 'percentage'){
		...
		jQuery("#woocommerce_rewards_settings_swr_rewards_points, #woocommerce_rewards_settings_swr_rewards_points_value, #woocommerce_rewards_settings_swr_rewards_min_points").parents("tr").hide();
