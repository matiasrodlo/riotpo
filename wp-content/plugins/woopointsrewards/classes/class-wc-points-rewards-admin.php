	...
	public static function get_settings() {
		...
		$settings = array(
			...
			array(
				...
				'desc_tip' => __( 'Set the maximum product discount allowed when redeeming points. Use either a fixed monetary amount or a percentage based on the product price. Leave blank to disable. This can be overridden at the category and product level.', 'wc_points_rewards' ),
