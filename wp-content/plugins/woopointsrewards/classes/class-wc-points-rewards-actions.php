...
class WC_Points_Rewards_Actions {
	...
	public function __construct() {
		...
		add_action( 'woocommerce_created_customer', array( $this, 'create_account_action' ) );
	...
	public function create_account_action() {
		...
		if ( ! empty( $points ) )
			WC_Points_Rewards_Manager::increase_points( get_current_user_id(), $points, 'account-signup' );
	}
