...
class WC_Points_Rewards_Points_Log_List_Table extends WP_List_Table {
	...
	/**
	 * Actually we have no actions to process, but sadly this seems to be the
	 * best way to remove the http_referer/nonce params
	 *
	 * @since 1.0
	 */
	public function process_actions() {
		if ( ! empty( $_REQUEST['_wp_http_referer'] ) ) {
			// remove _wp_http_referer/_wp_nonce params
