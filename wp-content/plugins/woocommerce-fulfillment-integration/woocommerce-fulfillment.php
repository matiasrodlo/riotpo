...
?>                                   
                ...
                <?php wp_nonce_field('woocommerce_efs-update-options'); ?>
                    <table width="100%" cellspacing="2" cellpadding="5" class="form-table"> 
                        <tr valign="top"> 
                            <th width="33%" scope="row"><?php _e('Merchant Id:', $this->localizationDomain); ?></th> 
                            <td><input name="efs_merchant_id" type="text" id="efs_merchant_id" value="<?php echo $this->options['efs_merchant_id'] ;?>"/>
                            <span style="color: silver; font-style: italic;">From "My Settings" in your Fulfillment Control Panel account.</span>
                        </td> 
                        </tr>
                        <tr valign="top"> 
                            <th width="33%" scope="row"><?php _e('Merchant Token:', $this->localizationDomain); ?></th> 
                            <td><input name="efs_merchant_token" type="text" id="efs_merchant_token" size="45" value="<?php echo $this->options['efs_merchant_token'] ;?>"/>
