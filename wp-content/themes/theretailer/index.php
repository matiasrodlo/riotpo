<?php get_header(); ?>
	...
	?>
    	...
    	<div class="grid_12">
            <div class="gbtr_home_no_widgets">
				<h2>Welcome to The Retailer!</h2>
                <h3>Esta es la página de bienvenida por defecto. <strong>Comience</strong> con la creación de su <a href="<?php echo site_url(); ?>/wp-admin/options-reading.php"><strong>Front Page</strong></a>.<h3>
                <img src="<?php echo get_template_directory_uri(); ?>/images/blank-state.jpg" alt="" />
            </div>
        </div>
